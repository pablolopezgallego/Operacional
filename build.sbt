...
libraryDependencies ++= Seq(
  ...
  //"org.apache.hbase" % "hbase-annotations" % "1.1.2" exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
  "org.apache.hbase" % "hbase" % hbaseVersion exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
  //"org.apache.hbase" % "hbase-hadoop-compat" % "1.1.2" exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
  //"org.apache.hbase" % "hbase-examples" % "1.1.2" exclude ("org.apache.hadoop","hadoop-yarn-server-web-proxy"),
